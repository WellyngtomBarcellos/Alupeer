...
<div class="app-modal" data-name="delete">
    <div class="app-modal-container">
        <div class="app-modal-card" data-name="delete" data-modal='0'>
            <div class="app-modal-header">Tem certeza que quer deletar ?</div>
            <div class="app-modal-body">essa ação não pode ser desfeita</div>
            <div class="app-modal-footer">
                <a href="javascript:void(0)" class="app-btn cancel">cancelar</a>
                <a href="javascript:void(0)" class="app-btn a-btn-danger delete">Sim</a>
            </div>
        </div>
    </div>
</div>
