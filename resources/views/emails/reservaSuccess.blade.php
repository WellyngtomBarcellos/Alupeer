...
<body>
    <div class="container">
        ...
        <div class="content">
            <h1>Olá, {{$locador['name']}} 😃</h1>
            <p>Sua reserva de <strong>{{ $item['name_item'] }}</strong> foi criada, Avisaremos por email e pelo seu menu
                de reservas
                quando ela for aprovada!</p>
        ...
        <div class="recebiveis">
            Após aprovação da reserva, um chat será liberado para conversar com <strong>{{ $user['name'] }}</strong>!
        </div>
        <div class="footer">
